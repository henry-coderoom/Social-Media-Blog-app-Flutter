...
class _AddPostScreenState extends State<AddPostScreen> {
  ...
  _switch() {
    ...
    Navigator.pushNamed(context, AddVideoPostScreen.routeName);
  }
  ...
  void uploadPost(
    ...
    try {
      ...
      final Reference storageReference = FirebaseStorage.instance
          .ref()
          .child("adminPostImages/$imageTitle - mainImage - $imageId");
                      ...
                      if (_formKey.currentState!.validate() && _file != null) {
                        ...
                        if (_file1 == null) {
                          ...
                          UploadTask upload1 = FirebaseStorage.instance
                              .ref()
                              .child(
                                  "adminPostImages/${_titleController.text} - media1")
                              .putData(_file1!);
                          String media1 =
